...
if (($begin > 0) and ($begin <= 10)) {
   $anteriores = '<a href="em_andamento.php?begin=0">Anteriores</a>';
} elseif (($begin > 0) and ($begin > 10)) {
   $anteriores = '<a href="em_andamento.php?begin=' . ($begin-10) . '">Anteriores</a>';
} else {
   $anteriores = 'Anteriores';
}
...
if (($begin < $total) and (($begin+10) >= $total)) {
   ...
   $proximos = '<a href="em_andamento.php?begin=' . ($begin+10) . '">Próximos</a>';
}
}
?>
<tr>
...
while ($linha = mysql_fetch_array($query)) {
   ...
   ?></p>
   <form id="finalizar" name="finalizar" method="post" action="update_finalizar.php">
