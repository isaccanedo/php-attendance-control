...
$query = "SELECT COUNT(*) FROM registros WHERE estado = 'FINALIZADO'";
...
<td height="490">&nbsp;
    ...
    <table width="526" border="0" align="center" cellpadding="2" cellspacing="0">
        ...
        <tr>
          <td height="19" class="bodyText"><p align="center" class="style1">TOTAL DE CHAMADOS FINALIZADOS: <span class="style3"><font color="#00FF40"><?php echo $total; ?></font></span></p>            </td>
        </tr>
        <tr>
...
$query = 'SELECT DISTINCT * FROM registros WHERE estado = "FINALIZADO" ORDER BY data_andamento  ASC LIMIT '.$begin.' , 10 ';
$query = mysql_query($query);
    ...
    <table width="694" border="0" align="center" cellpadding="2" cellspacing="0">
        ...
        <tr valign="top">
          ...
          <td colspan="3" align="right" class="style8" id="monthformat">
            <label></label>
  <label></label>
  <form id="atender" name="atender" method="post" action="painel_imprimir.php">
            <label>
